...
(function (window) {
  ...
  /**
   * Función que prepara el código HTML necesario para pintar los datos
   * @param {Object} pt: Objeto con datos demográficos del paciente
   */
  ...
  /**
   * Función que obtiene el nombre y apellido del paciente
   * @param {Object} pt:  Objeto con datos demográficos del paciente
   */
  ...
  /**
   * Función que obtiene el ID, género y fecha de nacimiento del paciente
   * @param {Object} pt:  Objeto con datos demográficos del paciente
   */
  ...
  /**
   * Función de búsqueda de datos demográficos
   */
  ...
  /**
   * Función de búsqueda de datos de catéteres
   */
  ...
  /**
   * Función de búsqueda de datos de ventilación
   */
  ...
  /**
   * Función de búsqueda de datos de hemodinámica
   */
  function searchHemo() {
  ...
  /**
   * Función de búsqueda de datos neurológicos
   */
  ...
  /**
   * Función de búsqueda de datos para balance hídrico
   */
  ...
  /**
   * Función de búsqueda de datos de medicación
   */
  ...
  /**
   * Función que obtiene y dibuja datos demográficos del paciente 
   * @param {array} json: Objeto con datos demográficos del paciente obtenidos desde un archivo json
   */
  ...
  /**
   * Función que obtiene y almacena los datos relacionados con signos vitales 
   * @param {Object} observation: objeto Observation de FHIR 
   */
  function getSignosVitales(observation) {
    let codingCode = [], fecha, fechaAux, valor = [], display = [], seq = [], unidades = [], fechaFormateada, y, m, d, h, min, showInd = true, auxCode = 0;
  ...
  /**
   * Función que obtiene y dibuja datos de catéteres
   * @param {array} json: Objeto con datos de catéteres del paciente obtenidos desde un archivo json
   */
  ...
  /**
   * Función que obtiene y dibuja datos de ventilación
   * @param {array} json: Objeto con datos de ventilación del paciente obtenidos desde un archivo json 
   */
  ...
  /**
   * Función que obtiene y dibuja datos de hemodinámica
   * @param {array} json: Objeto con datos de hemodinámica del paciente obtenidos desde un archivo json 
   */
  ...
  /**
   * Función que obtiene y dibuja datos de neuromonitorización
   * @param {array} json: Objeto con datos de neuromonitorización del paciente obtenidos desde un archivo json 
   */
  ...
  /**
   * Función que obtiene y dibuja datos de balance hídrico
   * @param {array} json: Objeto con datos de balance hídrico del paciente obtenidos desde un archivo json  
   */
  ...
  /**
   * Función que obtiene y dibuja datos de medicación
   * @param {array} json: Objeto con datos de medicación del paciente obtenidos desde un archivo json  
   */
  ...
  /**
   * Constructor del objeto timeline. Este objeto tiene todos los datos necesarios para pintar la gráfica de signos vitales.
   * @param {string} codigo: código LOINC del signo vital 
   * @param {number} seq: número de secuencia asignado a cada signo vital 
   * [1 = Sat O2; 2 = Temperatura; 3 = Frecuencia respiratoria; 4 = Frecuencia cardiaca; 5 = PVC; 6 = TAS; 7 = TAD; 8 = TAM ] 
   * @param {string} display: nombre del signo vital a almacenar
   * @param {number} yValor: valor del signo vital
   * @param {string} xValor: fecha en la que se tomó el signo vital 
   * @param {string} unidades: unidades del signo vital 
   * @param {boolean} show: indica si mostrar o no mostrar el signo vital 
   */
  ...
  /**
   * Función que crea los collapses con bootstrap
   * @param {string} target : ID de la sección div que contendrá los datos dibujados 
   * @param {string} id : ID del collapse 
   * @param {string} title : Título que se mostrará en el collapse 
   * @param {string} [card_body] : Cuerpo del collapse 
   */
  ...
  /**
   * Función que prepara los datos de la gráfica de signos vitales y llama a la función dibujaGráfica
   */
    ...
    if (data.length > 0) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (prevSeq != data[i].seq) {
          ...
          if (data[i].show_ind == true) {
            shownSeries = true;
            shownLabel = true;
          }

          vsData[vsSeq].push({
            xaxis: 'x2axis', yaxis: axis, minY: parseFloat(data[i].yValor), maxY: parseFloat(data[i].yValor),
      ...
      let xAxis = { show: true, autoscaleOnZoom: false, useSeriesColor: false, renderer: $.jqplot.DateAxisRenderer, labelRenderer: $.jqplot.CanvasAxisLabelRenderer, tickOptions: { fontSize: 12, mark: 'outside', showGridline: true, formatString: '%H' }, tickInterval: '1 hour', useDST: false, autoscale: false, pad: 1, min: newDtMin, max: newDtMax };
  ...
  /**
   * Función que dibuja la gráfica de signos vitales
   * @param {string} iId : ID de la sección div donde se dibujará la gráfica
   * @param {string} iSelect : ID donde dibujarán los botones y la leyenda de los diferentes signos vitales
   * @param {string} assignedTo : nombre de la variable donde está función devolverá la gráfica
   * @param {array} iDataSeries : formato [[[[xData,yData, display+unidades]],seriesOptionObject 
   * @param {object} iXAxisObj : opciones del objeto x Axis 2. Irá encima de la gráfica
   * @param {object} iYAxisObj : opciones del objeto y Axis. Irá a los lados de la gráfica
   */
  ...
  /**
   * Constructor del objeto que almacena los datos de los rangos de normalidad a dibujar
   * @param {number} rangoSup : valor de normalidad máximo
   * @param {number} rangoInf : valor de normalidad mínimo
   * @param {string} color : color de las lineas superior e inferior
   * @param {string} ejeY : eje Y asociado al rango y al signo vital
   * @param {string} id : nombre identificador del rango
   */
  ...
  /**
   * Función que devuelve un objeto parametro dependiendo de cuántos y cuáles sean los signos vitales presentes en cada día
   * @param {object} opciones : objeto con las opciones del signo vital correspondiente. Necesario para identificar qué signos vitales hay en el día seleccionado
   */
  ...
  // Función de ordenación de un array
  ...
  // Mapeado del tipo de sonda con el event_cd
  ...
  // Función de ayuda para convertir la fecha recibida del CCL
  ...
  // Función que añade ceros si el día o el mes tienen un sólo dígito
  function addZeros(i) {
    if (i < 10) {
      i = "0" + i;
    }
  ...
  // Función que actualiza los datos del balance hídrico mostrados en la parte superior
...
// Función que muestra u oculta los signos vitales cuando se hace click sobre el botón de la leyenda
...
// Función que selecciona el rango correspondiente al radio button seleccionado
...
// Función que dibuja los rangos y los signos vitales seleccionados
...
// Función que cambia el tamaño de la gráfica de signos vitales cuando se cambia el tamaño de la ventana
